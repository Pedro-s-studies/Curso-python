...
class OrdersRepository:
    ...
    def select_many_with_properties(self, doc_filter: dict) -> list:
        ...
        data = collection.find(
            doc_filter, {"_id": 0, "cupom": 0}  # filtro de busca  # Opções de retorno
        )
        return data
    ...
    def edit_registry(self) -> None:
        ...
        collection.update_one(
            {"_id": ObjectId("692eff8001a2d01bf2f9060f")},  # Filtros
            {"$set": {"itens.pizza.quantidade": 50}},  # Edição
        )
    ...
    def delete_registry(self) -> None:
        ...
        collection.delete_one(
            {"_id": ObjectId("692f0d5f9f94a9726f3e93c7")},  # Filtros
        )
